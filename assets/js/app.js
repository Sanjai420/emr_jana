...
const allDayCheckbox1 = document.getElementById('allDay1');
const timeContainer1 = document.getElementById('timeContainer1');

allDayCheckbox1.addEventListener('change', function() {
  if (this.checked) {
    timeContainer1.classList.add('hide');
  } else {
    timeContainer1.classList.remove('hide');
  }
});
